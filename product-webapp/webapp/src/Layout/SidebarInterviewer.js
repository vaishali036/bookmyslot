...
export const SidebarInterviewer = (props) => {
    ...
    return (
        <div
            className={s.sidebar}
            style={{ width: sidebarVisibility ? '100px' : '200px' }}
            onMouseEnter={() => {
        ...
        >
            ...
            <div className={s.sidebar_links} style={{ cursor: 'pointer' }}>
                {menuItem('Home','/interviewer/home', <FontAwesomeIcon icon={faHome} />)}
            </div>
            <div className={s.sidebar_links} style={{ cursor: 'pointer' }}>
                {menuItem('Dashboard', '/interviewer/dashboard', <FontAwesomeIcon icon={faDashboard} />)}
            </div>
